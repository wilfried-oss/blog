...
<body>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Derniers billets</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Derniers billets</li>
                            </ol>
                        </nav>
                    </div>
                    <div id="billets" class="row"></div>
    ...
    <script>
        $(function() {
            ...
            $(".card-body").on("click", "#close", function() {
                $(".modal").hide();
            });

            $(".card-body").on("click", ".btn-gradient-primary", function() {
